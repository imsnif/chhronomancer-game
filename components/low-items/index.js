...
export default function LowItems (props) {
  ...
  return (
    <View style={styles.itemContainer}>
      <Item key={1} fill={assist.fill} bright={assist.bright} name='assist' />
      <Item key={2} fill={prevent.fill} bright={prevent.bright} name='prevent' />
      <Item key={3} fill={reset.fill} bright={reset.bright} name='reset' />
      <Item key={4} fill={steal.fill} bright={steal.bright} name='steal' />
    </View>
  )
}
